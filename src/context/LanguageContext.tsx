...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'goals.tasks': 'Задачи',
    'goals.report': 'Отчёт',
    'goals.chat_with_bro': 'Отчёт по выполнению цели',
    'goals.chat_placeholder': 'Как продвигается цель, бро?',
    'chat.placeholder': 'Напиши мне, бро...',
    'chat.new': 'Новый чат',
    'chat.clear_btn': 'Очистить чат',
    'chat.clear_title': 'Очистить чат?',
    'chat.clear_desc': 'Выбери, как мы начнем заново. Бро может всё забыть или сохранить самое важное.',
    'chat.keep_context': 'Сохранить контекст',
    'chat.keep_context_desc': 'Я запомню твое имя и главные темы.',
    'chat.reset_all': 'Полный сброс',
    'chat.reset_all_desc': 'Начнем с нуля, как в первый раз.',
  ...
  en: {
    ...
    'goals.tasks': 'Tasks',
    'goals.report': 'Report',
    'goals.chat_with_bro': 'Goal Progress Report',
    'goals.chat_placeholder': 'How is the goal going, bro?',
    'chat.placeholder': 'Write to me, bro...',
    'chat.new': 'New Chat',
    'chat.clear_btn': 'Clear Chat',
    'chat.clear_title': 'Clear chat?',
    'chat.clear_desc': 'Choose how we start over. Bro can forget everything or keep the core insights.',
    'chat.keep_context': 'Keep context',
    'chat.keep_context_desc': 'I\'ll remember your name and key themes.',
    'chat.reset_all': 'Full reset',
    'chat.reset_all_desc': 'Start from scratch, like the first time.',
    'common.save': 'Save',
